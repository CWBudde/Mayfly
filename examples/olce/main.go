...
func main() {
	...
	fmt.Println("  • Chaotic compatibility stage: Logistic-map local search")
	fmt.Println("  • Orthogonal learning augments male movement")
	fmt.Println("  • Note: the published all-offspring Chebyshev equation remains an open fidelity item")
	fmt.Println("\nTypical performance:")
